...
class RobotiqCModelURCap:
    ...
    def connect(self, hostname, port=63352, socket_timeout=0.5):
...
if __name__ == '__main__':
    address = "10.0.65.161"
    gripper = RobotiqCModelURCap(address=address)
    gripper.move(255, 100, 5)
    # gripper.connect()
    # gripper.activate()
    # gripper.move_and_wait_for_pos(255, 255, 5)
